...
def oracledb_sync_example() -> None:
    ...
    with spec.provide_session(config) as driver:
        ...
        # Insert data
        driver.execute("INSERT INTO departments (name, budget, manager_name) VALUES (:1, :2, :3)", 
                      "Engineering", 500000.00, "Alice Johnson")
        ...
        page_departments = driver.select("SELECT * FROM departments ORDER BY name OFFSET :1 ROWS FETCH NEXT :2 ROWS ONLY", 0, 2)
