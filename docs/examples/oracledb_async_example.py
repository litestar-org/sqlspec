...
async def oracledb_async_example() -> None:
    ...
    async with spec.provide_session(config) as driver:
        ...
        # Insert data
        await driver.execute("INSERT INTO employees (name, salary, department) VALUES (:1, :2, :3)", 
                           "Alice Johnson", 75000.00, "Engineering")
        ...
        page_employees = await driver.select("SELECT * FROM employees ORDER BY name OFFSET :1 ROWS FETCH NEXT :2 ROWS ONLY", 0, 2)
