...
async def test_select_to_arrow_basic(psqlpy_driver: "PsqlpyDriver") -> None:
    ...
    await driver.execute("CREATE TABLE arrow_users_psqlpy (id INTEGER, name TEXT, age INTEGER)")
    await driver.execute("INSERT INTO arrow_users_psqlpy VALUES (1, 'Alice', 30), (2, 'Bob', 25)")

    try:
        result = await driver.select_to_arrow("SELECT * FROM arrow_users_psqlpy ORDER BY id")
        ...
        await _drop_table(driver, "arrow_users_psqlpy")
...
async def test_select_to_arrow_table_format(psqlpy_driver: "PsqlpyDriver") -> None:
    ...
    driver = psqlpy_driver
    await driver.execute("CREATE TABLE arrow_table_test_psqlpy (id INTEGER, value TEXT)")
    await driver.execute("INSERT INTO arrow_table_test_psqlpy VALUES (1, 'a'), (2, 'b'), (3, 'c')")

    try:
        result = await driver.select_to_arrow(
            "SELECT * FROM arrow_table_test_psqlpy ORDER BY id", return_format="table"
        )

        assert isinstance(result.data, pa.Table)
        assert result.rows_affected == 3
    finally:
        await _drop_table(driver, "arrow_table_test_psqlpy")
...
async def test_select_to_arrow_batch_format(psqlpy_driver: "PsqlpyDriver") -> None:
    ...
    driver = psqlpy_driver
    await driver.execute("DROP TABLE IF EXISTS arrow_batch_test_psqlpy CASCADE")
    await driver.execute("CREATE TABLE arrow_batch_test_psqlpy (id INTEGER, value TEXT)")
    await driver.execute("INSERT INTO arrow_batch_test_psqlpy VALUES (1, 'a'), (2, 'b')")

    try:
        result = await driver.select_to_arrow(
            "SELECT * FROM arrow_batch_test_psqlpy ORDER BY id", return_format="batch"
        )

        assert isinstance(result.data, pa.RecordBatch)
        assert result.rows_affected == 2
    finally:
        await _drop_table(driver, "arrow_batch_test_psqlpy")
...
async def test_select_to_arrow_with_parameters(psqlpy_driver: "PsqlpyDriver") -> None:
    ...
    driver = psqlpy_driver
    await driver.execute("CREATE TABLE arrow_params_test_psqlpy (id INTEGER, value INTEGER)")
    await driver.execute("INSERT INTO arrow_params_test_psqlpy VALUES (1, 100), (2, 200), (3, 300)")

    try:
        result = await driver.select_to_arrow(
            "SELECT * FROM arrow_params_test_psqlpy WHERE value > $1 ORDER BY id", (150,)
        )

        df = result.to_pandas()
        assert list(df["value"]) == [200, 300]
    finally:
        await _drop_table(driver, "arrow_params_test_psqlpy")
...
async def test_select_to_arrow_empty_result(psqlpy_driver: "PsqlpyDriver") -> None:
    ...
    driver = psqlpy_driver
    await driver.execute("CREATE TABLE arrow_empty_test_psqlpy (id INTEGER)")

    try:
        result = await driver.select_to_arrow("SELECT * FROM arrow_empty_test_psqlpy WHERE id > 100")
...
async def test_select_to_arrow_type_preservation(psqlpy_driver: "PsqlpyDriver") -> None:
    ...
    driver = psqlpy_driver
    await driver.execute("DROP TABLE IF EXISTS arrow_types_test_psqlpy CASCADE")
    await driver.execute(
        """
            CREATE TABLE arrow_types_test_psqlpy (
                id INTEGER,
                name TEXT,
                price NUMERIC,
    ...
    await driver.execute(
        """
            INSERT INTO arrow_types_test_psqlpy VALUES
    ...
    try:
        result = await driver.select_to_arrow("SELECT * FROM arrow_types_test_psqlpy ORDER BY id")
