"""Integration tests for aiomysql (MySQL) migration workflow."""
...
async def test_aiomysql_migration_full_workflow(tmp_path: Path, mysql_service: MySQLService) -> None:
    """Test full aiomysql migration workflow: init -> create -> upgrade -> downgrade."""

    test_id = "aiomysql_full_workflow"
...
async def test_aiomysql_multiple_migrations_workflow(tmp_path: Path, mysql_service: MySQLService) -> None:
    """Test aiomysql workflow with multiple migrations: create -> apply both -> downgrade one -> downgrade all."""

    test_id = "aiomysql_multiple_workflow"
    migration_table = f"sqlspec_migrations_{test_id}"
    users_table = f"users_{test_id}"
...
async def test_aiomysql_migration_current_command(tmp_path: Path, mysql_service: MySQLService) -> None:
    """Test the current migration command shows correct version for aiomysql."""

    test_id = "aiomysql_current_cmd"
    migration_table = f"sqlspec_migrations_{test_id}"
    users_table = f"users_{test_id}"
...
async def test_aiomysql_migration_error_handling(tmp_path: Path, mysql_service: MySQLService) -> None:
    """Test aiomysql migration error handling."""

    test_id = "aiomysql_error_handling"
    migration_table = f"sqlspec_migrations_{test_id}"
...
async def test_aiomysql_migration_with_transactions(tmp_path: Path, mysql_service: MySQLService) -> None:
    """Test aiomysql migrations work properly with transactions."""

    test_id = "aiomysql_transactions"
    migration_table = f"sqlspec_migrations_{test_id}"
    users_table = f"users_{test_id}"
