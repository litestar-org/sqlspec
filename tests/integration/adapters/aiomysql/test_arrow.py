...
async def test_select_to_arrow_basic(aiomysql_driver: AiomysqlDriver) -> None:
    ...
    await aiomysql_driver.execute("CREATE TABLE IF NOT EXISTS arrow_users (id INT, name VARCHAR(100), age INT)")
    await aiomysql_driver.execute("INSERT INTO arrow_users VALUES (1, 'Alice', 30), (2, 'Bob', 25)")

    result = await aiomysql_driver.select_to_arrow("SELECT * FROM arrow_users ORDER BY id")
...
async def test_select_to_arrow_table_format(aiomysql_driver: AiomysqlDriver) -> None:
    ...
    await aiomysql_driver.execute("CREATE TABLE IF NOT EXISTS arrow_table_test (id INT, value VARCHAR(100))")
    await aiomysql_driver.execute("INSERT INTO arrow_table_test VALUES (1, 'a'), (2, 'b'), (3, 'c')")

    result = await aiomysql_driver.select_to_arrow("SELECT * FROM arrow_table_test ORDER BY id", return_format="table")
...
async def test_select_to_arrow_with_parameters(aiomysql_driver: AiomysqlDriver) -> None:
    ...
    await aiomysql_driver.execute("CREATE TABLE IF NOT EXISTS arrow_params_test (id INT, value INT)")
    await aiomysql_driver.execute("INSERT INTO arrow_params_test VALUES (1, 100), (2, 200), (3, 300)")
...
async def test_select_to_arrow_empty_result(aiomysql_driver: AiomysqlDriver) -> None:
    ...
    await aiomysql_driver.execute("CREATE TABLE IF NOT EXISTS arrow_empty_test (id INT)")

    result = await aiomysql_driver.select_to_arrow("SELECT * FROM arrow_empty_test")
...
async def test_select_to_arrow_type_preservation(aiomysql_driver: AiomysqlDriver) -> None:
    ...
    result = await aiomysql_driver.select_to_arrow("SELECT * FROM arrow_types_test ORDER BY id")
...
async def test_select_to_arrow_json_handling(aiomysql_driver: AiomysqlDriver) -> None:
    ...
    await aiomysql_driver.execute("CREATE TABLE IF NOT EXISTS arrow_json_test (id INT, data JSON)")
    await aiomysql_driver.execute(
        """
    ...
    result = await aiomysql_driver.select_to_arrow("SELECT * FROM arrow_json_test ORDER BY id")
