...
async def asyncmy_clean_driver(asyncmy_config: "AsyncmyConfig") -> "AsyncGenerator[AsyncmyDriver, None]":
    ...
    async with asyncmy_config.provide_session() as driver:
        ...
        cleanup_tables = [
            "test_table_asyncmy",
            "data_types_test_asyncmy",
            "user_profiles_asyncmy",
            "test_parameter_conversion_asyncmy",
            "transaction_test_asyncmy",
            "concurrent_test_asyncmy",
            "arrow_users_asyncmy",
            "arrow_table_test_asyncmy",
            "arrow_batch_test_asyncmy",
            "arrow_params_test_asyncmy",
            "arrow_empty_test_asyncmy",
            "arrow_null_test_asyncmy",
            "arrow_polars_test_asyncmy",
            "arrow_large_test_asyncmy",
            "arrow_types_test_asyncmy",
            "arrow_json_test_asyncmy",
            "driver_feature_test_asyncmy",
        ]
