...
class DriverCase:
    ...
    supports_data_dictionary_core: bool = False
    supports_data_dictionary_constraints: bool = False
    supports_data_dictionary_ddl: bool = False
...
SYNC_DRIVER_CASES = (
    ...
    DriverCase(
        ...
        supports_data_dictionary_ddl=True,
        supports_data_dictionary_system=True,
        supports_data_dictionary_topology=True,
        ...
        extra_assertions=(
            "param_codecs:mysql",
            "streaming_native:mysqlconnector",
    ...
    DriverCase(
        ...
        supports_connection_instance=True,
        supports_native_row_streaming=True,
        extra_assertions=("param_codecs:mysql", "streaming_native:pymysql", "stream_cursor_cleanup:start_failure"),
    ),
    DriverCase(
        id="psycopg-sync",
    ...
    DriverCase(
        ...
        supports_connection_instance=True,
        supports_native_row_streaming=True,
        extra_assertions=("param_codecs:cockroach_psycopg", "streaming_native:psycopg", "stream_error_close:pg"),
    ),
    DriverCase(
        id="adbc-sqlite-sync",
        supports_arrow_streaming=True,
    ...
    DriverCase(
        ...
        supports_data_dictionary_constraints=True,
        supports_data_dictionary_ddl=True,
        supports_data_dictionary_dependencies=True,
        supports_schema_qualified_data_dictionary=True,
    ...
    DriverCase(
        id="mssql-python-sync",
        fixture_name="contract_mssql_python_driver",
        adapter="mssql_python",
        dialect="tsql",
        mode="sync",
    ...
    DriverCase(
        id="pymssql-sync",
        fixture_name="contract_pymssql_driver",
        adapter="pymssql",
        dialect="tsql",
        mode="sync",
        marks=(MSSQL_MARK, MSSQL_XDIST_MARK),
...
ASYNC_DRIVER_CASES = (
    ...
    DriverCase(
        ...
        supports_connection_instance=True,
        extra_assertions=("param_codecs:cockroach_asyncpg", "streaming_native:asyncpg", "stream_error_close:pg"),
    ),
    DriverCase(
