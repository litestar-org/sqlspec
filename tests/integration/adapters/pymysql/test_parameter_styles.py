...
def test_qmark_conversion_qmark_single_parameter(pymysql_parameter_session: PyMysqlDriver) -> None:
...
def test_qmark_conversion_qmark_multiple_parameters(pymysql_parameter_session: PyMysqlDriver) -> None:
...
def test_qmark_conversion_qmark_in_insert(pymysql_parameter_session: PyMysqlDriver) -> None:
...
def test_qmark_conversion_qmark_in_update(pymysql_parameter_session: PyMysqlDriver) -> None:
    """Test ? placeholders in UPDATE statements."""
    pymysql_parameter_session.execute("UPDATE test_parameter_conversion SET value = ? WHERE name = ?", (999, "test1"))
    result = pymysql_parameter_session.execute("SELECT * FROM test_parameter_conversion WHERE name = ?", ("test1",))
    assert result.get_data()[0]["value"] == 999


def test_named_colon_conversion_named_colon_single_parameter(pymysql_parameter_session: PyMysqlDriver) -> None:
...
def test_named_colon_conversion_named_colon_multiple_parameters(pymysql_parameter_session: PyMysqlDriver) -> None:
...
def test_named_colon_conversion_named_colon_repeated_parameter(pymysql_parameter_session: PyMysqlDriver) -> None:
...
def test_named_colon_conversion_named_colon_in_insert(pymysql_parameter_session: PyMysqlDriver) -> None:
...
def test_named_pyformat_conversion_named_pyformat_single_parameter(pymysql_parameter_session: PyMysqlDriver) -> None:
...
def test_named_pyformat_conversion_named_pyformat_multiple_parameters(pymysql_parameter_session: PyMysqlDriver) -> None:
...
def test_positional_pyformat_native_pyformat_single_parameter(pymysql_parameter_session: PyMysqlDriver) -> None:
    """Test single %s placeholder works directly."""
    result = pymysql_parameter_session.execute("SELECT * FROM test_parameter_conversion WHERE name = %s", ("test1",))
    assert isinstance(result, SQLResult)
    assert len(result.data) == 1
    assert result.get_data()[0]["name"] == "test1"


def test_positional_pyformat_native_pyformat_multiple_parameters(pymysql_parameter_session: PyMysqlDriver) -> None:
...
def test_sql_object_conversion_sql_object_with_qmark(pymysql_parameter_session: PyMysqlDriver) -> None:
...
def test_sql_object_conversion_sql_object_with_pyformat(pymysql_parameter_session: PyMysqlDriver) -> None:
...
def test_data_type_conversion_integer_parameters(pymysql_parameter_session: PyMysqlDriver) -> None:
...
def test_data_type_conversion_float_parameters(pymysql_parameter_session: PyMysqlDriver) -> None:
...
def test_data_type_conversion_none_parameters(pymysql_parameter_session: PyMysqlDriver) -> None:
...
def test_data_type_conversion_boolean_parameters(pymysql_parameter_session: PyMysqlDriver) -> None:
...
def test_execute_many_execute_many_with_qmark(pymysql_parameter_session: PyMysqlDriver) -> None:
...
def test_execute_many_execute_many_with_pyformat(pymysql_parameter_session: PyMysqlDriver) -> None:
...
def test_edge_cases_empty_string_parameter(pymysql_parameter_session: PyMysqlDriver) -> None:
    """Test empty string parameters."""
    pymysql_parameter_session.execute(
        "INSERT INTO test_parameter_conversion (name, value, description) VALUES (?, ?, ?)", ("empty_desc", 0, "")
    )
    result = pymysql_parameter_session.execute("SELECT * FROM test_parameter_conversion WHERE description = ?", ("",))
    assert len(result.data) == 1
    assert result.get_data()[0]["name"] == "empty_desc"


def test_edge_cases_special_characters_in_parameters(pymysql_parameter_session: PyMysqlDriver) -> None:
    ...
    result = pymysql_parameter_session.execute("SELECT * FROM test_parameter_conversion WHERE name = ?", ("special",))
    assert len(result.data) == 1
    assert result.get_data()[0]["description"] == special_value


def test_edge_cases_sql_injection_prevention(pymysql_parameter_session: PyMysqlDriver) -> None:
...
def test_edge_cases_like_with_wildcards(pymysql_parameter_session: PyMysqlDriver) -> None:
    """Test LIKE queries with wildcard parameters."""
    result = pymysql_parameter_session.execute("SELECT * FROM test_parameter_conversion WHERE name LIKE ?", ("test%",))
