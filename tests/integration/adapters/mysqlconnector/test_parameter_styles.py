...
def test_sync_qmark_conversion_qmark_single_parameter(
    mysqlconnector_sync_parameter_session: MysqlConnectorSyncDriver,
) -> None:
...
def test_sync_positional_pyformat_native_pyformat_parameters(
    mysqlconnector_sync_parameter_session: MysqlConnectorSyncDriver,
) -> None:
...
def test_sync_sql_object_sql_object_with_qmark(mysqlconnector_sync_parameter_session: MysqlConnectorSyncDriver) -> None:
...
def test_sync_execute_many_execute_many_with_qmark(
    mysqlconnector_sync_parameter_session: MysqlConnectorSyncDriver,
) -> None:
...
def test_sync_edge_cases_boolean_parameters(mysqlconnector_sync_parameter_session: MysqlConnectorSyncDriver) -> None:
...
async def test_async_qmark_conversion_qmark_single_parameter(
    mysqlconnector_async_parameter_session: MysqlConnectorAsyncDriver,
) -> None:
    """Test single ? placeholder gets converted to %s."""
...
async def test_async_positional_pyformat_native_pyformat_parameters(
    mysqlconnector_async_parameter_session: MysqlConnectorAsyncDriver,
) -> None:
    """Test %s placeholders work directly."""
    result = await mysqlconnector_async_parameter_session.execute(
...
async def test_async_execute_many_execute_many_with_qmark(
    mysqlconnector_async_parameter_session: MysqlConnectorAsyncDriver,
) -> None:
    """Test execute_many with ? placeholders."""
    data = [("batch1", 1001, "Batch 1"), ("batch2", 1002, "Batch 2"), ("batch3", 1003, "Batch 3")]
...
async def test_async_edge_cases_boolean_parameters(
    mysqlconnector_async_parameter_session: MysqlConnectorAsyncDriver,
) -> None:
    """Test boolean parameters are converted to integers for MySQL."""
