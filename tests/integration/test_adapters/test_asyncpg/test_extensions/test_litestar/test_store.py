...
@pytest.fixture
async def asyncpg_store(postgres_service):
...
@pytest.mark.asyncio
async def test_store_create_table(asyncpg_store):
    """Test table creation."""
    assert asyncpg_store.table_name == "test_sessions"


@pytest.mark.asyncio
async def test_store_set_and_get(asyncpg_store):
...
@pytest.mark.asyncio
async def test_store_get_nonexistent(asyncpg_store):
...
@pytest.mark.asyncio
async def test_store_set_with_string_value(asyncpg_store):
...
@pytest.mark.asyncio
async def test_store_delete(asyncpg_store):
...
@pytest.mark.asyncio
async def test_store_delete_nonexistent(asyncpg_store):
    """Test deleting a non-existent session is a no-op."""
    await asyncpg_store.delete("nonexistent")


@pytest.mark.asyncio
async def test_store_expiration_with_int(asyncpg_store):
...
@pytest.mark.asyncio
async def test_store_expiration_with_timedelta(asyncpg_store):
...
@pytest.mark.asyncio
async def test_store_no_expiration(asyncpg_store):
...
@pytest.mark.asyncio
async def test_store_expires_in(asyncpg_store):
...
@pytest.mark.asyncio
async def test_store_expires_in_expired(asyncpg_store):
...
@pytest.mark.asyncio
async def test_store_cleanup(asyncpg_store):
...
@pytest.mark.asyncio
async def test_store_upsert(asyncpg_store):
...
@pytest.mark.asyncio
async def test_store_upsert_with_expiration_change(asyncpg_store):
...
@pytest.mark.asyncio
async def test_store_renew_for(asyncpg_store):
...
@pytest.mark.asyncio
async def test_store_large_data(asyncpg_store):
...
@pytest.mark.asyncio
async def test_store_delete_all(asyncpg_store):
...
@pytest.mark.asyncio
async def test_store_exists(asyncpg_store):
    """Test exists method."""
...
@pytest.mark.asyncio
async def test_store_context_manager(asyncpg_store):
