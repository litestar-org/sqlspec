...
async def test_asyncpg_config_migrate_up_method(postgres_service: PostgresService) -> None:
...
async def test_asyncpg_config_migrate_down_method(postgres_service: PostgresService) -> None:
...
async def test_asyncpg_config_get_current_migration_method(postgres_service: PostgresService) -> None:
    ...
    with tempfile.TemporaryDirectory() as temp_dir:
        ...
        config = AsyncpgConfig(
            ...
            migration_config={
                "script_location": str(migration_dir),
                "version_table_name": "sqlspec_migrations_current",
            },
        )
...
async def test_asyncpg_config_create_migration_method(postgres_service: PostgresService) -> None:
...
async def test_asyncpg_config_stamp_migration_method(postgres_service: PostgresService) -> None:
...
async def test_asyncpg_config_fix_migrations_dry_run(postgres_service: PostgresService) -> None:
