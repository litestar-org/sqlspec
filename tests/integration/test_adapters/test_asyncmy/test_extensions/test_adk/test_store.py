...
@pytest.fixture
async def asyncmy_adk_store(asyncmy_pool_config: dict) -> AsyncmyADKStore:
    """Create AsyncMY ADK store with test database.

    Args:
        asyncmy_pool_config: Pytest fixture providing MySQL connection config.
    ...
    """
    config = AsyncmyConfig(pool_config=asyncmy_pool_config)
...
@pytest.fixture
async def asyncmy_adk_store_with_fk(asyncmy_pool_config: dict) -> AsyncmyADKStore:
