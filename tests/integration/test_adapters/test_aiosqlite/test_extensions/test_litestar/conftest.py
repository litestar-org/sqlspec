...
@pytest.fixture
async def aiosqlite_migration_config() -> AsyncGenerator[AiosqliteConfig, None]:
...
@pytest.fixture
async def aiosqlite_migration_config_with_dict() -> AsyncGenerator[AiosqliteConfig, None]:
...
@pytest.fixture
async def aiosqlite_migration_config_mixed() -> AsyncGenerator[AiosqliteConfig, None]:
