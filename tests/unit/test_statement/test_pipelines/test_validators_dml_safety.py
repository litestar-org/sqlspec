...
class TestDMLSafetyValidator:
    ...
    def test_ddl_blocked_when_disabled(self, context) -> None:
    ...
    def test_ddl_allowed_when_enabled(self, context) -> None:
    ...
    def test_risky_dml_detection(self, context) -> None:
    ...
    def test_allowed_operations_filtering(self, context) -> None:
    ...
    def test_blocked_operations_filtering(self, context) -> None:
    ...
    def test_system_table_detection(self, context) -> None:
    ...
    def test_admin_command_detection(self, context) -> None:
    ...
    def test_update_without_where_detection(self, context) -> None:
    ...
    def test_truncate_detection(self, context) -> None:
    ...
    def test_multiple_issues_aggregation(self, context) -> None:
    ...
    def test_safe_dml_with_where(self, context) -> None:
    ...
    def test_complex_query_categorization(self, validator, context) -> None:
