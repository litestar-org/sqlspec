...
class TestMergeBuilder:
    """Test cases for MergeBuilder."""
    ...
    def test_merge_with_subquery_source(self) -> None:
    ...
    def test_merge_when_matched_then_delete(self) -> None:
        """Test MERGE with DELETE action for matched rows."""
        builder = merge()
        result = (
            builder.into("users")
            .using("inactive_users", "src")
            .on("users.id = src.id")
    ...
    def test_merge_when_not_matched_then_insert(self) -> None:
    ...
    def test_merge_multiple_when_clauses(self) -> None:
    ...
    def test_merge_with_conditions(self) -> None:
    ...
    def test_merge_parameter_binding(self) -> None:
    ...
    def test_merge_chaining(self) -> None:
    ...
    def test_merge_insert_column_value_mismatch(self) -> None:
    ...
    def test_merge_insert_columns_without_values(self) -> None:
    ...
    def test_merge_insert_values_without_columns(self) -> None:
    ...
    def test_merge_insert_default_values(self) -> None:
    ...
    def test_merge_condition_parsing_error(self) -> None:
    ...
    def test_merge_with_table_alias(self) -> None:
    ...
    def test_merge_string_representation(self) -> None:
    ...
    def test_merge_not_matched_by_source(self) -> None:
