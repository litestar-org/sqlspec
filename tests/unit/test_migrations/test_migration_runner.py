...
class TestMigrationRunnerInitialization:
    """Test MigrationRunner initialization and setup."""
    ...
    def test_migration_runner_with_project_root(self) -> None:
        ...
        runner = TestMigrationRunner(migrations_path, project_root)

        assert runner.migrations_path == migrations_path
        assert runner.project_root == project_root


class TestMigrationRunnerFileDiscovery:
    """Test migration file discovery and sorting functionality."""
    ...
    def test_get_migration_files_sorting(self) -> None:
        ...
        class TestMigrationRunner(BaseMigrationRunner):
            ...
            def get_migration_files(self) -> Any:
                # Return the sync implementation for testing
...
class TestMigrationRunnerMetadataLoading:
    """Test migration metadata loading functionality."""
...
class TestMigrationRunnerSQLGeneration:
    ...
    def test_get_migration_sql_upgrade_success(self) -> None:
        ...
        with patch("sqlspec.migrations.base.run_") as mock_run, patch("sqlspec.core.statement.SQL") as mock_sql_class:
            ...
            # Should return SQL object
            assert result == mock_sql_instance
            mock_sql_class.assert_called_once_with("CREATE TABLE test (id INTEGER PRIMARY KEY);")
    ...
    def test_get_migration_sql_downgrade_success(self) -> None:
        ...
        with patch("sqlspec.migrations.base.run_") as mock_run, patch("sqlspec.core.statement.SQL") as mock_sql_class:
            ...
            assert result == mock_sql_instance
            mock_sql_class.assert_called_once_with("DROP TABLE test;")
    ...
    def test_get_migration_sql_loader_exception_upgrade(self) -> None:
        ...
        with patch("sqlspec.migrations.base.run_") as mock_run:
            # Mock loader exception
            mock_run.side_effect = Exception("Loader failed to parse migration")
    ...
    def test_get_migration_sql_loader_exception_downgrade(self) -> None:
        ...
        with patch("sqlspec.migrations.base.run_") as mock_run, patch("sqlspec.migrations.base.logger") as mock_logger:
            ...
            assert "Failed to load downgrade for migration 0001" in warning_call[0]
...
class TestMigrationRunnerErrorHandling:
    """Test error handling in migration runner operations."""
...
class TestMigrationRunnerPerformance:
    """Test performance aspects of migration runner."""
