"""aiomysql LOAD DATA LOCAL INFILE bulk-load helpers and config gate."""

import pytest

from sqlspec.adapters.aiomysql.config import AiomysqlConfig
from sqlspec.adapters.aiomysql.core import build_load_data_statement, encode_records_for_local_infile
...
def test_config_gate_raises_when_local_infile_disabled() -> None:
    with pytest.raises(ImproperConfigurationError):
        AiomysqlConfig(driver_features={"enable_local_infile_bulk_load": True})
