...
class TestBaseStatementCache:
    ...
    def test_cache_eviction(self):
        ...
        _ = cache.get_or_parse("SELECT 1")
        _ = cache.get_or_parse("SELECT 2")
        _ = cache.get_or_parse("SELECT 3")
        ...
        _ = cache.get_or_parse("SELECT 1")  # miss - was evicted
        ...
        _ = cache.get_or_parse("SELECT 2")  # miss - was evicted when we added 1
        _ = cache.get_or_parse("SELECT 3")  # miss - was evicted when we added 2
        _ = cache.get_or_parse("SELECT 4")  # miss - was evicted when we added 3
    ...
    def test_lru_ordering(self):
        ...
        _ = cache.get_or_parse("SELECT 4")

        # Check what's in cache
        initial_hits = cache._hit_count
        _ = cache.get_or_parse("SELECT 1")  # Should hit
        _ = cache.get_or_parse("SELECT 3")  # Should hit
        _ = cache.get_or_parse("SELECT 4")  # Should hit
    ...
    def test_sql_normalization(self):
        ...
        _ = [cache.get_or_parse(sql) for sql in sqls]
