...
class TestBigQueryStorageOperations:
    ...
    def test_export_to_storage_parquet_gcs(self, bigquery_driver: BigQueryDriver, tmp_path: Any) -> None:
        ...
        bigquery_driver._export_native.assert_called_once_with(
            "SELECT * FROM users", gcs_path, "parquet"
        )
    ...
    def test_export_to_storage_parquet_local(self, bigquery_driver: BigQueryDriver, tmp_path: Any) -> None:
        ...
        bigquery_driver._resolve_backend_and_path = MagicMock(return_value=(mock_backend, str(tmp_path / "output.parquet")))
    ...
    def test_import_from_storage_parquet(self, bigquery_driver: BigQueryDriver, tmp_path: Any) -> None:
        ...
        # Patch the _resolve_backend_and_path method to return our mock
        bigquery_driver._resolve_backend_and_path = MagicMock(return_value=(mock_backend, str(tmp_path / "input.parquet")))
    ...
    def test_fetch_arrow_table_with_filters(self, bigquery_driver: BigQueryDriver, mock_bigquery_client: MagicMock) -> None:
        ...
        statement = SQL("SELECT * FROM users")
        result = bigquery_driver.fetch_arrow_table(statement, None, active_filter)
    ...
    def test_ingest_arrow_table_with_mode_replace(self, bigquery_driver: BigQueryDriver, mock_bigquery_client: MagicMock) -> None:
    ...
    def test_arrow_table_conversion_with_nulls(self, bigquery_driver: BigQueryDriver, mock_bigquery_client: MagicMock) -> None:
