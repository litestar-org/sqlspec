...
class TestDuckDBStorageOperations:
    ...
    def test_ingest_arrow_table(self, duckdb_driver: DuckDBDriver, mock_duckdb_connection: MagicMock) -> None:
        ...
        result = duckdb_driver.ingest_arrow_table(table, "test_table")
    ...
    def test_export_to_storage_parquet(self, duckdb_driver: DuckDBDriver, mock_duckdb_connection: MagicMock, tmp_path: Any) -> None:
    ...
    def test_export_to_storage_csv(self, duckdb_driver: DuckDBDriver, mock_duckdb_connection: MagicMock, tmp_path: Any) -> None:
    ...
    def test_import_from_storage_parquet(self, duckdb_driver: DuckDBDriver, mock_duckdb_connection: MagicMock, tmp_path: Any) -> None:
    ...
    def test_export_to_storage_json(self, duckdb_driver: DuckDBDriver, mock_duckdb_connection: MagicMock, tmp_path: Any) -> None:
    ...
    def test_import_from_storage_csv(self, duckdb_driver: DuckDBDriver, mock_duckdb_connection: MagicMock, tmp_path: Any) -> None:
    ...
    def test_fetch_arrow_table_with_filters(self, duckdb_driver: DuckDBDriver, mock_duckdb_connection: MagicMock) -> None:
        ...
        statement = SQL("SELECT * FROM users")
        result = duckdb_driver.fetch_arrow_table(statement, None, active_filter)
    ...
    def test_ingest_arrow_table_with_mode_replace(self, duckdb_driver: DuckDBDriver, mock_duckdb_connection: MagicMock) -> None:
    ...
    def test_arrow_table_conversion_with_nulls(self, duckdb_driver: DuckDBDriver, mock_duckdb_connection: MagicMock) -> None:
    ...
    def test_ingest_arrow_table_native_path(self, duckdb_driver: DuckDBDriver, mock_duckdb_connection: MagicMock) -> None:
