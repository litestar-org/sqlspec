...
class TestAsyncMyStorageOperations:
    ...
    async def test_export_to_storage_csv(self, asyncmy_driver: AsyncmyDriver, tmp_path: Any) -> None:
        ...
        asyncmy_driver._export_to_storage = AsyncMock(return_value=2)
        ...
        asyncmy_driver._export_to_storage.assert_called_once_with("SELECT * FROM users", str(output_path), "csv")
    ...
    async def test_export_to_storage_json(self, asyncmy_driver: AsyncmyDriver, tmp_path: Any) -> None:
        ...
        asyncmy_driver._export_to_storage.assert_called_once_with("SELECT * FROM users", str(output_path), "json")
    ...
    async def test_import_from_storage_csv(self, asyncmy_driver: AsyncmyDriver, tmp_path: Any) -> None:
        ...
        asyncmy_driver._import_from_storage = AsyncMock(return_value=2)
        ...
        asyncmy_driver._import_from_storage.assert_called_once_with(str(input_path), "test_table", "csv", "create")
    ...
    async def test_fetch_arrow_table_with_filters(self, asyncmy_driver: AsyncmyDriver) -> None:
        ...
        statement = SQL("SELECT * FROM users")
        result = await asyncmy_driver.fetch_arrow_table(statement, None, mock_filter)
