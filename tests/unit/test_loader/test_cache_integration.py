...
class TestCacheConfiguration:
    ...
    def test_cache_disabled_loading(self, mock_get_cache_config: Mock) -> None:
...
""")
    ...
    def test_cache_enabled_loading(self, mock_get_cache: Mock, mock_get_cache_config: Mock) -> None:
...
class TestCacheKeyGeneration:
    ...
    def test_file_cache_key_generation(self) -> None:
    ...
    def test_cache_key_with_path_object(self) -> None:
...
class TestCacheHitScenarios:
    """Test cache hit scenarios and performance."""
    ...
    def test_cache_hit_scenario(self, mock_cache_setup: tuple[Mock, Mock, SQLFileLoader]) -> None:
        """Test successful cache hit scenario."""
        mock_config, mock_cache, loader = mock_cache_setup
...
"""
    ...
    def test_cache_miss_scenario(self, mock_cache_setup: tuple[Mock, Mock, SQLFileLoader]) -> None:
...
"""
    ...
    def test_cache_invalidation_on_file_change(self, mock_cache_setup: tuple[Mock, Mock, SQLFileLoader]) -> None:
...
class TestCacheInvalidationScenarios:
    ...
    def test_file_content_change_detection(self) -> None:
        ...
        with tempfile.NamedTemporaryFile(mode="w", suffix=".sql", delete=False) as tf:
            ...
            with open(tf.name, "w") as f:
                f.write("SELECT 'modified' as content;")
    ...
    def test_file_deletion_handling(self) -> None:
    ...
    def test_checksum_calculation_error_handling(self) -> None:
...
class TestCacheStorageAndRetrieval:
    """Test cache storage and retrieval mechanisms."""

    def test_cached_sqlfile_structure(self) -> None:
...
"""
    ...
    def test_namespace_handling_in_cache(self) -> None:
...
""")
    ...
    def test_cache_restoration_with_namespace(self) -> None:
...
class TestCacheMemoryManagement:
    ...
    def test_cache_clear_integration(self) -> None:
    ...
    def test_file_cache_only_clear(self) -> None:
    ...
    def test_cache_disabled_clear_behavior(self) -> None:
...
class TestMultiLoaderCacheSharing:
    """Test cache sharing between multiple loader instances."""

    def test_cache_sharing_between_loaders(self) -> None:
...
"""
    ...
    def test_cache_isolation_between_loaders(self) -> None:
...
class TestCachePerformanceOptimizations:
    ...
    def test_cache_key_performance(self) -> None:
    ...
    def test_checksum_calculation_performance(self) -> None:
    ...
    def test_cache_hit_performance_benefit(self) -> None:
