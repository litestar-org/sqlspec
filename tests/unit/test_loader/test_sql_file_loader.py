...
class TestNamedStatement:
    """Test NamedStatement data structure."""

    def test_named_statement_creation(self) -> None:
    ...
    def test_named_statement_no_dialect(self) -> None:
    ...
    def test_named_statement_slots(self) -> None:
...
class TestSQLFile:
    """Test SQLFile data structure."""

    def test_sqlfile_creation(self) -> None:
    ...
    def test_sqlfile_checksum_calculation(self) -> None:
    ...
    def test_sqlfile_with_metadata(self) -> None:
...
class TestCachedSQLFile:
    """Test CachedSQLFile structure."""

    def test_cached_sqlfile_creation(self) -> None:
        """Test CachedSQLFile creation."""
        sql_file = SQLFile("SELECT 1", "test.sql")
        statements = {
            "query1": NamedStatement("query1", "SELECT 1"),
            "query2": NamedStatement("query2", "SELECT 2")
        }
    ...
    def test_cached_sqlfile_slots(self) -> None:
...
class TestSQLFileLoaderInitialization:
    """Test SQLFileLoader initialization and configuration."""
    ...
    def test_custom_storage_registry(self) -> None:
...
class TestSQLFileLoaderParsing:
    """Test SQL file parsing functionality."""

    def test_parse_simple_named_statements(self) -> None:
...
"""
    ...
    def test_parse_statements_with_dialects(self) -> None:
...
"""
    ...
    def test_parse_normalize_query_names(self) -> None:
...
"""
    ...
    def test_parse_error_no_named_statements(self) -> None:
    ...
    def test_parse_error_duplicate_names(self) -> None:
...
"""
    ...
    def test_parse_invalid_dialect_warning(self) -> None:
...
"""
    ...
    def test_strip_leading_comments(self) -> None:
...
"""
    ...
    def test_strip_leading_comments_all_comments(self) -> None:
...
class TestSQLFileLoaderCacheIntegration:
    """Test cache integration functionality."""

    def test_generate_file_cache_key(self) -> None:
    ...
    def test_is_file_unchanged(self) -> None:
...
class TestSQLFileLoaderQueryManagement:
    ...
    def test_add_named_sql_duplicate_error(self) -> None:
    ...
    def test_get_query_text(self) -> None:
    ...
    def test_get_query_text_not_found(self) -> None:
...
class TestSQLFileLoaderSQLGeneration:
    """Test SQL object generation from loaded queries."""

    def test_get_sql_basic(self) -> None:
    ...
    def test_get_sql_with_parameters(self) -> None:
    ...
    def test_get_sql_with_dialect(self) -> None:
    ...
    def test_get_sql_with_dialect_override(self) -> None:
    ...
    def test_get_sql_parameter_style_detection(self) -> None:
    ...
    def test_get_sql_name_normalization(self) -> None:
    ...
    def test_get_file_methods(self) -> None:
...
class TestSQLFileLoaderParameterValidation:
    """Test parameter validation and processing."""

    @patch("sqlspec.loader.ParameterValidator")
    def test_parameter_style_detection_with_validator(self, mock_validator_class: Mock) -> None:
    ...
    def test_query_name_normalization_edge_cases(self) -> None:
...
class TestSQLFileLoaderErrorHandling:
    """Test error handling scenarios."""

    def test_parse_error_propagation(self) -> None:
...
"""  # Empty name should cause error
    ...
    def test_file_read_error_handling(self) -> None:
    ...
    def test_checksum_calculation_error(self) -> None:
    ...
    def test_invalid_dialect_suggestions(self) -> None:
