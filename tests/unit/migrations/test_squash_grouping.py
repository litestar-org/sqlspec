...
def test_group_migrations_by_type_group_all_sql() -> None:
...
def test_group_migrations_by_type_group_all_python() -> None:
...
def test_group_migrations_by_type_group_mixed_alternating() -> None:
...
def test_group_migrations_by_type_group_mixed_consecutive() -> None:
...
def test_group_migrations_by_type_group_empty_list() -> None:
