...
def test_resolve_use_logger_method_param_true_returns_true(sync_config: SqliteConfig) -> None:
...
def test_resolve_use_logger_method_param_false_config_default_false(sync_config: SqliteConfig) -> None:
    """When method parameter is False and config has no default, return False."""
    commands = SyncMigrationCommands(sync_config)
    assert commands._resolve_use_logger(False) is False


def test_resolve_use_logger_method_param_false_config_default_true(sync_config_with_use_logger: SqliteConfig) -> None:
...
def test_resolve_use_logger_config_default_applies(sync_config_with_use_logger: SqliteConfig) -> None:
    """Config default should be used when method param is False."""
    commands = SyncMigrationCommands(sync_config_with_use_logger)
    assert commands._resolve_use_logger(False) is True


def test_sync_upgrade_use_logger_use_logger_true_uses_logger(sync_config: SqliteConfig) -> None:
...
def test_sync_upgrade_use_logger_use_logger_false_uses_console(sync_config: SqliteConfig) -> None:
...
def test_sync_upgrade_use_logger_config_default_use_logger_true(sync_config_with_use_logger: SqliteConfig) -> None:
...
def test_sync_upgrade_use_logger_already_at_latest_uses_logger(sync_config: SqliteConfig) -> None:
...
def test_sync_downgrade_use_logger_use_logger_true_uses_logger(sync_config: SqliteConfig) -> None:
    """use_logger=True should output to logger instead of console."""
    commands = SyncMigrationCommands(sync_config)
    mock_driver = MagicMock()
    with (
...
def test_sync_downgrade_use_logger_use_logger_false_uses_console(sync_config: SqliteConfig) -> None:
    """use_logger=False (default) should output to Rich console."""
    commands = SyncMigrationCommands(sync_config)
    mock_driver = MagicMock()
    with (
...
async def test_async_upgrade_use_logger_use_logger_true_uses_logger(async_config: AiosqliteConfig) -> None:
    """use_logger=True should output to logger instead of console."""
...
async def test_async_upgrade_use_logger_use_logger_false_uses_console(async_config: AiosqliteConfig) -> None:
    """use_logger=False (default) should output to Rich console."""
    commands = AsyncMigrationCommands(async_config)
    mock_driver = AsyncMock()
    mock_driver.driver_features = {}
...
async def test_async_upgrade_use_logger_config_default_use_logger_true(
    async_config_with_use_logger: AiosqliteConfig,
) -> None:
    """MigrationConfig use_logger=True should be used as default."""
...
async def test_async_downgrade_use_logger_use_logger_true_uses_logger(async_config: AiosqliteConfig) -> None:
    """use_logger=True should output to logger instead of console."""
    commands = AsyncMigrationCommands(async_config)
    mock_driver = AsyncMock()
    mock_driver.driver_features = {}
...
async def test_async_downgrade_use_logger_use_logger_false_uses_console(async_config: AiosqliteConfig) -> None:
    """use_logger=False (default) should output to Rich console."""
    commands = AsyncMigrationCommands(async_config)
    mock_driver = AsyncMock()
    mock_driver.driver_features = {}
...
def test_config_migrate_up_use_logger_sync_config_migrate_up_passes_use_logger(sync_config: SqliteConfig) -> None:
...
def test_config_migrate_up_use_logger_sync_config_migrate_down_passes_use_logger(sync_config: SqliteConfig) -> None:
...
async def test_config_migrate_up_use_logger_async_config_migrate_up_passes_use_logger(
...
async def test_config_migrate_up_use_logger_async_config_migrate_down_passes_use_logger(
    async_config: AiosqliteConfig,
) -> None:
...
def test_dry_run_with_use_logger_sync_upgrade_dry_run_uses_logger(sync_config: SqliteConfig) -> None:
...
def test_dry_run_with_use_logger_sync_downgrade_dry_run_uses_logger(sync_config: SqliteConfig) -> None:
    """Dry run mode with use_logger=True should log the dry run message."""
    commands = SyncMigrationCommands(sync_config)
    mock_driver = MagicMock()
    with (
