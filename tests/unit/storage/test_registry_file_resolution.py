...
def test_storage_registry_file_path_resolution_load_multiple_files_from_directory() -> None:
...
def test_storage_registry_file_path_resolution_file_and_directory_share_same_backend() -> None:
