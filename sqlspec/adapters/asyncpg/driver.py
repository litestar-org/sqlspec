...
from sqlspec.adapters.asyncpg._typing import ASYNCPG_MODULE, AsyncpgCursor, AsyncpgSessionContext
...
_POSTGRES_ERROR = cast("type[BaseException]", getattr(ASYNCPG_MODULE, "PostgresError", Exception))
