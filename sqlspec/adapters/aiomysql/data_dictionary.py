...
class AiomysqlDataDictionary(AsyncDataDictionaryBase):
    ...
    async def get_version(self, driver: "AiomysqlDriver") -> "VersionInfo | None":
    ...
    async def get_feature_flag(self, driver: "AiomysqlDriver", feature: str) -> bool:
    ...
    async def get_schemas(self, driver: "AiomysqlDriver") -> "MetadataResult":
    ...
    async def get_objects(self, driver: "AiomysqlDriver", schema: "str | None" = None) -> "MetadataResult":
    ...
    async def get_table_details(
        self, driver: "AiomysqlDriver", table: str, schema: "str | None" = None
    ) -> "MetadataResult":
    ...
    async def get_constraints(
        self, driver: "AiomysqlDriver", table: "str | None" = None, schema: "str | None" = None
    ) -> "MetadataResult":
    ...
    async def get_views(self, driver: "AiomysqlDriver", schema: "str | None" = None) -> "MetadataResult":
    ...
    async def get_routines(self, driver: "AiomysqlDriver", schema: "str | None" = None) -> "MetadataResult":
    ...
    async def get_privileges(
        self, driver: "AiomysqlDriver", object_name: "str | None" = None, schema: "str | None" = None
    ) -> "MetadataResult":
    ...
    async def get_tables(self, driver: "AiomysqlDriver", schema: "str | None" = None) -> "list[TableMetadata]":
    ...
    async def _get_metadata_dialect(self, driver: "AiomysqlDriver") -> str:
        engine_version = await self._get_engine_version(driver)
