...
class PsycopgSyncConfig(SyncDatabaseConfig[PsycopgSyncConnection, PsycopgSyncConnectionPool, PsycopgSyncDriver]):
    ...
    def __init__(
        ...
        *,
        ...
        connection_instance: "PsycopgSyncConnectionPool | None" = None,
    ...
    def _create_pool(self) -> "PsycopgSyncConnectionPool":
        ...
        if conninfo:
            pool = PsycopgSyncConnectionPool(conninfo, open=True, **pool_parameters)
        else:
            kwargs = all_config.pop("kwargs", {})
            all_config.update(kwargs)
            pool = PsycopgSyncConnectionPool("", kwargs=all_config, open=True, **pool_parameters)
    ...
    def provide_pool(self, *args: Any, **kwargs: Any) -> "PsycopgSyncConnectionPool":
