...
from sqlspec.adapters.duckdb._typing import DUCKDB_MODULE, DuckDBCursor, DuckDBSessionContext
...
_DUCKDB_ERROR = cast("type[BaseException]", getattr(DUCKDB_MODULE, "Error", Exception))
