"""Type converters for pymssql parameter binding."""
...
__all__ = ("PymssqlTypeConverter", "mssql_type_to_arrow")
...
class PymssqlTypeConverter:
    ...
    def coerce_bind_value(self, value: "Any") -> "Any":
        """Coerce Python values before pymssql parameter binding."""
    ...
    def coerce_read_value(self, value: "Any") -> "Any":
        """Coerce pymssql result values after fetching."""
        return value
