...
class MysqlConnectorSyncDataDictionary(SyncDataDictionaryBase):
    ...
    def get_ddl(
        self, driver: "MysqlConnectorSyncDriver", object_name: str, schema: "str | None" = None
    ) -> "MetadataResult":
    ...
    def get_system_metadata(
        self, driver: "MysqlConnectorSyncDriver", domain: str, *, include_sensitive: bool = False
    ) -> "MetadataResult":
...
class MysqlConnectorAsyncDataDictionary(AsyncDataDictionaryBase):
    ...
    async def get_ddl(
        self, driver: "MysqlConnectorAsyncDriver", object_name: str, schema: "str | None" = None
    ) -> "MetadataResult":
        """Get native SHOW CREATE output and replay-sensitive context for a table."""
        schema_name = self._resolve_metadata_schema(schema)
    ...
    async def get_system_metadata(
        self, driver: "MysqlConnectorAsyncDriver", domain: str, *, include_sensitive: bool = False
    ) -> "MetadataResult":
        """Get opt-in system metadata from performance_schema or sys."""
        dialect = await self._get_metadata_dialect(driver)
        capability = build_mysql_metadata_capability_profile(dialect, type(self).__name__).get("system")
