...
class GenericAdapter(SyncDriverAdapterProtocol):
    ...
    def select(
        self, connection: Any, sql: str, parameters: list | dict, record_class: Callable | None
    ) -> Iterable[Any]:
    ...
    def select_scalar(self, connection: Any, sql: str, parameters: list | dict) -> Any | None:
    ...
    @contextmanager
    def with_cursor(self, connection: Any, sql: str, parameters: list | dict) -> Generator[Any, None, None]:
    ...
    def insert_update_delete(self, connection: Any, sql: str, parameters: list | dict) -> int:
    ...
    def insert_update_delete_returning(self, connection: Any, sql: str, parameters: list | dict) -> Any:
    ...
    def insert_update_delete_many(self, connection: Any, sql: str, parameters: list | dict) -> int:
        """Handle affected row counts (INSERT UPDATE DELETE) (``*!`` suffix)."""
        cur = self._cursor(connection)
        try:
    ...
    def insert_update_delete_many_returning(self, connection: Any, sql: str, parameters: list | dict) -> list:
        """Special case for RETURNING (``<!`` suffix) with SQLite."""
        # very similar to select_one but the returned value
        cur = self._cursor(connection)
        cur.executemany(sql, parameters)
