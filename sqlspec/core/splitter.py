...
__all__ = ("SQLScript", "SplitterMode", "StatementInfo", "StatementSplitter")
...
class SQLScript:
    ...
    __slots__ = ("_statement_cache", "mode", "original_script", "statements")

    def __init__(
        self, statements: "list[StatementInfo]", original_script: str, mode: SplitterMode = SplitterMode.STANDARD
    ) -> None:
    ...
    def statement_count(self) -> int:
        ...
        # PLACEHOLDER - Will copy exact implementation during BUILD phase
        msg = "BUILD phase - will copy exact statement_count implementation"
        raise NotImplementedError(msg)
    ...
    def get_statement_at_position(self, char_pos: int) -> Optional[StatementInfo]:
        ...
        """
        # PLACEHOLDER - Will copy exact implementation during BUILD phase
        msg = "BUILD phase - will copy exact position mapping"
        raise NotImplementedError(msg)
...
class StatementSplitter:
    ...
    __slots__ = ("_comment_patterns", "_delimiter_patterns", "_string_patterns", "mode")
    ...
    def __init__(self, mode: SplitterMode = SplitterMode.STANDARD) -> None:
        ...
        msg = "BUILD phase - will copy exact StatementSplitter initialization"
        raise NotImplementedError(msg)
    ...
    def split(self, script: str) -> SQLScript:
        ...
        msg = "BUILD phase - will copy exact split implementation"
        raise NotImplementedError(msg)
    ...
    def _find_statement_boundaries(self, script: str) -> "list[tuple[int, int]]":
        ...
        msg = "BUILD phase - will copy exact boundary detection"
        raise NotImplementedError(msg)
    ...
    def _handle_string_literals(self, script: str, pos: int) -> int:
        ...
        """
        # PLACEHOLDER - Will copy exact implementation during BUILD phase
        msg = "BUILD phase - will copy exact string literal handling"
        raise NotImplementedError(msg)
    ...
    def _handle_comments(self, script: str, pos: int) -> int:
        ...
        """
        # PLACEHOLDER - Will copy exact implementation during BUILD phase
        msg = "BUILD phase - will copy exact comment handling"
        raise NotImplementedError(msg)
    ...
    def _detect_statement_type(self, statement: str) -> Optional[str]:
        ...
        """
        # PLACEHOLDER - Will copy exact implementation during BUILD phase
        msg = "BUILD phase - will copy exact type detection"
        raise NotImplementedError(msg)
    ...
    def _calculate_line_numbers(self, script: str, boundaries: "list[tuple[int, int]]") -> "list[int]":
        ...
        """
        # PLACEHOLDER - Will copy exact implementation during BUILD phase
        msg = "BUILD phase - will copy exact line number calculation"
        raise NotImplementedError(msg)
...
def split_sql_script(script: str, mode: SplitterMode = SplitterMode.STANDARD) -> SQLScript:
    ...
    """
    # PLACEHOLDER - Will copy exact implementation during BUILD phase
    msg = "BUILD phase - will copy exact split_sql_script implementation"
    raise NotImplementedError(msg)
...
def is_single_statement(script: str, mode: SplitterMode = SplitterMode.STANDARD) -> bool:
    ...
    """
    # PLACEHOLDER - Will copy exact implementation during BUILD phase
    msg = "BUILD phase - will copy exact single statement detection"
    raise NotImplementedError(msg)
...
def extract_first_statement(script: str, mode: SplitterMode = SplitterMode.STANDARD) -> str:
    ...
    """
    # PLACEHOLDER - Will copy exact implementation during BUILD phase
    msg = "BUILD phase - will copy exact first statement extraction"
    raise NotImplementedError(msg)
