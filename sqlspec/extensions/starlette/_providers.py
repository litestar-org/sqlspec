"""Provider functions for SQLSpec Starlette integration."""
...
def create_pool_provider(
    ...
    async def provide_pool() -> "PoolT":
        ...
        Raises:
            ImproperConfigurationError: If the pool is not properly initialized.
        """
        # For Starlette, we would need access to app.state
        # This is a simplified version - in practice you'd need to pass app state
...
def create_connection_provider(
    ...
    async def provide_connection() -> "AsyncGenerator[ConnectionT, None]":
        ...
        Raises:
            ImproperConfigurationError: If the pool is not found.
        """
        # Create a temporary pool for this connection
        # In practice, you'd get this from app.state
        db_pool = await ensure_async_(config.create_pool)()
