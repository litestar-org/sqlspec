"""Interpreted Arrow conversion helpers for SQLSpec.

This module holds PyArrow interactions in interpreted code to avoid mypyc
segmentation faults when compiled drivers touch Arrow objects.
"""
